    ...
    <div id="season-5" class="side-bar-item-container">
        <div class="side-bar-item">
            ...
            <div id="season-5-dropdown" class="side-bar-expandable-container hidden">
                ...
                <a href="${backdirs}s5/battle-facilities" class="side-bar-expandable">Battle Facilities</a>
                <a href="${backdirs}s5/caves" class="side-bar-expandable">Caves</a>
                <a href="${backdirs}s5/champion-battles" class="side-bar-expandable">Champion Battles</a>
                <a href="${backdirs}s5/dungeons" class="side-bar-expandable">Dungeons</a>
                <a href="${backdirs}s5/elite-four-battles" class="side-bar-expandable">Elite Four Battles</a>
                <a href="${backdirs}s5/evil-team-areas" class="side-bar-expandable">Gym Leader Battles</a>
                <a href="${backdirs}s5/evil-team-battles" class="side-bar-expandable">Evil Team Battles</a>
                <a href="${backdirs}s5/evil-team-leader-battles" class="side-bar-expandable">Evil Team Leader Battles</a>
                <a href="${backdirs}s5/forests" class="side-bar-expandable">Forests</a>
                <a href="${backdirs}s5/gym-leader-battles" class="side-bar-expandable">Gym Leader Battles</a>
                <a href="${backdirs}s5/important-npc-encounters" class="side-bar-expandable">Important NPC Encounters</a>
                <a href="${backdirs}s5/jacobs-grab-bag" class="side-bar-expandable">Jacob's Grab Bag</a>
                <a href="${backdirs}s5/legendary-mythical-battles" class="side-bar-expandable">Legendary &amp; Mythical Battles</a>
                <a href="${backdirs}s5/minigames" class="side-bar-expandable">Minigames</a>
                <a href="${backdirs}s5/mystery-dungeons" class="side-bar-expandable">Mystery Dungeons</a>
                <a href="${backdirs}s5/numbered-routes" class="side-bar-expandable">Numbered Routes</a>
                <a href="${backdirs}s5/online-accessories" class="side-bar-expandable">Online & Accessories</a>
                <a href="${backdirs}s5/professors-labs" class="side-bar-expandable">Professors & Labs</a>
                <a href="${backdirs}s5/recreational-areas" class="side-bar-expandable">Recreational Areas</a>
                ...
                <a href="${backdirs}s5/shops" class="side-bar-expandable">Shops</a>
                <a href="${backdirs}s5/staff-rolls" class="side-bar-expandable">Staff Rolls</a>
                ...
                <a href="${backdirs}s5/wild-areas" class="side-bar-expandable">Wild Areas</a>
